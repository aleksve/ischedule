...
Schedule periodic tasks in a Python program. Simple syntax, precise timing, no busy waiting. The project was originally made for an an industrial automation application. No bugs has been reported since the first published version.
