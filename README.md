...
Schedule periodic tasks in a Python program. Simple syntax, precise timing, no busy waiting. No bugs reported after over 12000 downloads and extensive use in industrial automation.
