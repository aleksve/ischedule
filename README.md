...
Schedule periodic tasks in a Python program. Simple syntax, precise timing, no busy waiting. The project is used by the author in industrial automation. No bugs has been reported since the first published version.
